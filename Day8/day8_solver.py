...
def extract_data(file_path):
    ...
    return first_elem, elements, instructions
...
first_elem, elements, instructions = extract_data(file_path)
total_steps = walk_instructions(first_elem, elements, instructions)
